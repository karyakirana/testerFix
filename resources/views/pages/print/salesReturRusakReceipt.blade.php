<x-MetronicsLayout>
    ...
    <x-mikro.card-custom>
        ...
        <x-slot name="toolbar">
            <div>
                <select class="form-control input" id="printer"></select>
            </div>

            <a href="#" onclick="webprint.printRaw(printEsc(), $('#printer').val());" class="btn btn-primary ml-2">
                <span class="svg-icon svg-icon-md">
                    <i class="text-light-50 flaticon2-print"></i>
                </span>Print
            </a>
        </x-slot>
        <pre id="tampilan"></pre>
    ...
    @push('scripts')
        ...
        <script src="/js/invoicePenjualan.js"></script>
        ...
        <script>
            ...
            function tampilanEsc()
            {
                ...
                var subTotal = 0;
                barisUtama = '';
                barisUtama += getEscTable('Nota Retur Rusak', 40, 'left')+ getEscTable('Colly =', 50, 'left') + getEscTable("Surabaya : "+ utama.tgl_nota, 47, 'left')+'\n';
            ...
            function printEsc()
            {
                ...
                barisUtama += alt_cond_off+bold_on+ esc_ul_on+getEscTable('Nota Retur Rusak', 15, 'left')+ bold_off+esc_ul_off+alt_cond_on +bold_on+ getEscTable('Colly =', 56, 'left')+bold_off + getEscTable("Surabaya : "+ utama.tgl_nota, 27, 'left')+'\n';
                barisUtama += getEscTable('', 40, 'left')+ getEscTable('', 50, 'left') + getEscTable('Kepada Yth, : ' +utama.namaCustomer, 47, 'left')+'\n';
