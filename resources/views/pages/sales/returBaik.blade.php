<x-makro.list-data>
    ...
    <x-mikro.card-custom>
        ...
        <x-slot name="title">Daftar Retur Baik</x-slot>
        <x-slot name="toolbar">
            <a href="{{ route('returBaikNew') }}" class="btn btn-primary font-weight-bolder">New Record</a>
        </x-slot>
        ...
        <x-nano.modal-large id="modalDetil">
            <x-slot name="title">Detil Retur</x-slot>
