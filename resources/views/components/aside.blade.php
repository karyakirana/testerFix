<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
        ...
        <ul class="menu-nav">
            ...
            <li class="menu-item menu-item-submenu {{ (request()->is('sales*')) ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        <li class="menu-item {{ (request()->is('sales')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                        ...
                        <li class="menu-item {{ (request()->is('sales/penjualan')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            <a href="/sales/penjualan" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
            ...
            <li class="menu-item menu-item-submenu {{ (request()->is('stock/rusak*')) ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                <a href="javascript:" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Files/Upload.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <div class="menu-submenu">
                    <i class="menu-arrow"></i>
                    <ul class="menu-subnav">
                        <li class="menu-item {{ (request()->is('stock/rusak/real')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            <a href="/stock/rusak/real" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Stock Rusak List</span>
                            </a>
                        </li>
                        <li class="menu-item {{ (request()->is('stock/rusak/masuk')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            <a href="/stock/rusak/masuk" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Stock Rusak Masuk</span>
                            </a>
                        </li>
                        <li class="menu-item {{ (request()->is('stock/rusak/keluar')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            <a href="/stock/rusak/keluar" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Stock Rusak Keluar</span>
                            </a>
                        </li>
                        <li class="menu-item {{ (request()->is('stock/rusak/mutasi/baik/rusak')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            <a href="/stock/rusak/mutasi/baik/rusak" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Mutasi Stock Baik ke Rusak</span>
                            </a>
                        </li>
                        <li class="menu-item {{ (request()->is('stock/rusak/mutasi/rusak')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            <a href="/stock/rusak/mutasi/rusak" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Mutasi Stock Rusak</span>
                            </a>
                        </li>
                    </ul>
                </div>
