<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
        ...
        <ul class="menu-nav">
            ...
            <li class="menu-item menu-item-submenu {{ (request()->is('tagihan*')) ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                <a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <ul class="menu-subnav">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="features/bootstrap/button-group.html" class="menu-link">
                                ...
                                <span class="menu-text">Pengeluaran List</span>
                            </a>
                        </li>
                        <li class="menu-item" aria-haspopup="true">
            ...
            </li><li class="menu-item menu-item-submenu {{ (request()->is('kasir*')) ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                <a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <ul class="menu-subnav">
                        ...
                        <li class="menu-item {{ (request()->is('kasir/pembayarannota/baru')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            <a href="{{ route('jurnalPembayaranNotaBaru') }}" class="menu-link">
                                ...
                                <span class="menu-text">Daftar Tagihan</span>
                            </a>
                        </li>
                        <li class="menu-item" aria-haspopup="true">
                            <a href="features/bootstrap/button-group.html" class="menu-link">
                                ...
                                <span class="menu-text">Tambahan Biaya Penjualan</span>
                            </a>
                        </li>
                        <li class="menu-item" aria-haspopup="true">
                            <a href="features/bootstrap/dropdown.html" class="menu-link">
                                ...
                                <span class="menu-text">Pembayaran Nota Tempo</span>
                            </a>
                        </li>
                        <li class="menu-item" aria-haspopup="true">
                            <a href="features/bootstrap/navs.html" class="menu-link">
                                ...
                                <span class="menu-text">Pembayaran Nota Cash</span>
                            </a>
                        </li>
                    </ul>
                </div>
