<div class="d-flex justify-content-between align-items-center flex-wrap">
    @if ($paginator->hasPages())
        ...
        <nav class="d-flex flex-wrap py-2 mr-3">
            <ul class="pagination">
                {{-- Previous Page Link --}}
    ...
    {{-- pgination and displaying number --}}
        <div class="d-flex align-items-center py-3">
            <span class="text-muted">Displaying {{ $paginator->firstItem() }} of {{ $paginator->total() }} records</span>
        </div>
