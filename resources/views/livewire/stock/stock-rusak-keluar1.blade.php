<div>
    <x-mikro.card-custom>
        ...
        <x-slot name="title">Transaksi Stock Keluar Rusak</x-slot>
            ...
            <div class="col-lg-8">
                <form action="#" id="formGlobal" class="form">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-lg-2 col-form-label text-lg-right">Tgl Keluar</label>
                        <div class="col-lg-4">
                        ...
                        <form id="formTable">
                            <table class="table table-bordered" width="100%" id="tableTransaksi">
                                ...
                                @forelse($detailStockRusak as $index => $item)
                                    <tr>
                                        <td class="text-center">{{ $item['kode_lokal'] }}</td>
